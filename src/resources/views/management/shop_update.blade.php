...
@section('title','management_shop_update')

@section('css')
<link rel="stylesheet" href="{{ asset('css/management/shop_update.css')}}">
@endsection
...
<div class="shop_create-wrap">
    ...
    <div class="information-area">
        ...
        <div class="button-area">
            <button type="submit" form="form" class="button">承認する</button>
        </div>
    </div>
</div>
